      ...
      require("nightfox").setup({
        ...
        groups = {
          all = {
            ...
            AerialLevel0Icon = { fg = "palette.magenta" },
            AerialLevel1Icon = { fg = "palette.blue" },
            AerialLevel2Icon = { fg = "palette.pink" },
            AerialLevel3Icon = { fg = "palette.green" },
            AerialLevel4Icon = { fg = "palette.yellow" },
            AerialLevel5Icon = { fg = "palette.cyan" },
            AerialGuide1 = { fg = "palette.magenta" },
            AerialGuide2 = { fg = "palette.blue" },
            AerialGuide3 = { fg = "palette.pink" },
            AerialGuide4 = { fg = "palette.green" },
            AerialGuide5 = { fg = "palette.yellow" },
            AerialGuide6 = { fg = "palette.cyan" },
